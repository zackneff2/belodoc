      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav nav-pills pull-right">
            ...
            <li class="hidden1">
              <a data-scroll="" data-options="{ &quot;easing&quot;: &quot;easeOutCubic&quot; }" href="#treat">What We Treat</a>
            </li>
            <li>
    ...
    <div id="home">
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-7 hot-text wow fadeInUp">
              <h1>Get treated by a Board-Certified Dermatologist from Home</h1>
              <div class="hot-description wow fadeInUp">
                <h3>The best acne and anti-aging products for you, straight to your door</h3>
                <p><a href="get/signup-get.php?plan=subscription">Start your free trial now</a></p>
              </div>
            ...
            <div class="col-sm-5 wow fadeInUp">
              <img src="girl1.png" alt="BeloDoc Bitch" class="img-responsive girl" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container"> 
            ...
            <div class="row top">
              <div class="col-md-4 wow solution box-grey fadeInUp" id="box-one">
                ...
                <p>Submit pictures and answer a short survey about your area of desired improvement.</p>
                </div>
              </div>
             <div class="col-md-4 solution box" id="box-two">
              ...
              <div class="icon">
                  ...
                  <p>Our award winning dermatologist will perform a comprehensive review of your submission.</p>
              </div>
            </div>  
              <div class="col-md-4 solution box-grey wow fadeInUp" id="box-three">
                ...
                <div class="icon">
                  <h3>Results</h3>
                  <p>You will receive results within 2 business days detailing a product regimen specific to your needs.</p>
                </div>
              </div>
          </div>
          <div class="row learn wow fadeInUp">
            <!--THIS LINK --> <a data-scroll="" data-options="{ &quot;easing&quot;: &quot;easeOutCubic&quot; }" href="#treat"><h3>Learn More</h3><i class="fa fa-angle-down fa-2x fa-learn"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="section treat">
        <div class="container">
          ...
          <div class="row learn wow fadeInUp">
            <!--THIS LINK --> <a data-scroll="" data-options="{ &quot;easing&quot;: &quot;easeOutCubic&quot; }" href="#video"><h3>Learn More</h3><i class="fa fa-angle-down fa-2x fa-learn"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="section video">
        <div class="container"> 
          <div class="row header top box fade-in one fadeInUp">
            <h2>Skincare is complex</h2>
            <span class="divider"></span>
          </div>
          <div class="row">
            <div class="col-sm-12 col-md-5 video-box box fade-in two fadeInUp">
            ...
            <div class="col-sm-12 col-md-7 video-side box fade-in two fadeInUp">
              ...
              <div class="side-text">
                <div class="hidden-xs side-icon">
                  ...
                  <h3>Inefficient Access to Professional Advice</h3>
                <div class="side-description">
      ...
      <div class="section pricing">
        <div class="container">
          ...
          <div class="row">
            <div class="price col-sm-6 col-md-6 best box fade-in two fadeInUp">
              <div class="price-inner">
                <div class="black">
                  <span class="dolla">$</span>
                  <h1 style="font-weight:500;">50</h1>
                  <span class="consult"><h2>/Quarter</h2></span>
                  <div class="price-icon"><i class="fa fa-3x fa-star"></i></div>
                </div>
                ...
                <div class="pricing-features">
                  <ul>
                    ...
                    <li>Product and regimen tracking and reminders</li>
            ...
            <div class="price col-sm-6 col-md-6 box fade-in two fadeInUp">
              <div class="price-inner">
                  ...
                  <div class="pricing-features" style="padding-top: 60px;">
                    <ul>
      ...
      <div class="section state">
        <div class="container">
            <div class="state">
              <div class="row header box fade-in one fadeInUp">
                <h2>We're currently in Michigan</h2>
              </div>
              <div class="row box soon fade-in two fadeInUp">
                <h2>Soon we'll be coming to Illinois, Florida, California, New York, and more</h2>
                <h3>Sign up to stay notified when treatment is available in your state</h3>
