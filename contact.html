...
<html lang="en">
  ...
  <body id="index">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav nav-pills pull-right">
            ...
            <li class="button"><a href="/pro/logout.php"><button type="button" class="top btn btn-default navbar-btn">Sign Out</button></a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <div class="submission">
      <div class="container">
        <div class="row">
          <h1 class="submission"><?php echo $message; ?></h1>
        </div>
      </div>
    </div>
  </body>
