...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Get beautiful skin without leaving your home. Select your state.">
    ...
    <title>BeloDoc - Your Online Dermatologists - Select your state</title>
...
<!-- End Inspectlet Embed Code -->
  ...
  <body id="index">
    ...
    <form id="state-form" name="state-form" method="post" action="/post/state-post.php">
      <div class="section">
        <div class="container">
          <div class="row header primary" id="select-state">
            <h1>Select Your State</h1>
            <label for="state" class="primary">In order to properly direct your treatment, please tell us where you currently live.</label>
                <span id="stateWarning"></span>
                ...
                <input type="submit" value="Continue" id="state-submit" class="btn belo-btn"/>
          </div>
        </div>
      </div>
    </form>
    ...
    $('#state-submit').click(function() {
      if (document.forms["state-form"]["state"].value == "" || document.forms["state-form"]["state"].value == null) {
        $('#stateWarning').text('Please select an option below.');
        return false;
      }
    });
    </script>
